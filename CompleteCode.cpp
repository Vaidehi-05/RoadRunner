...
unordered_map<string, float> dijkstra(const Graph& graph, const string& start, float a = 0.5f, float b = 1.0f) {
...
unordered_map<string, float> computeHeuristic(const Graph& graph, const string& goal, float a = 0.5f, float b = 1.0f) {
